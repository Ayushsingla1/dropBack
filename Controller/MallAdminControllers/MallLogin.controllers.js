const mallOwner = require("../../Models/MallAdminSchema");
...
exports.MallAdminLogin = async (req, res) => {
  try {
    ...
    let MallAdminEmail = await owner.findOne({
      mallName,
      email: mallEmail,
      mallId,
      password,
    ...
    const payload = {
      email: MallAdminEmail.mallEmail,
      id: MallAdminEmail._id,
      mallName: MallAdminEmail.mallName,
      mallId: MallAdminEmail.mallId,
    };
